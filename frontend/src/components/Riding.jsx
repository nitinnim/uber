...
const Riding = () => {
  return (
    <div className="h-screen">
        <Link to="/home" className="fixed top-4 right-4 w-4 h-4 p-4 flex items-center justify-center rounded-full bg-white">
      ...
      <div className="h-1/2 p-3 flex flex-col gap-3 items-center">
        ...
        <button
          className="w-full bg-green-600 text-lg mt-4 text-white font-semibold rounded-lg py-2"
          onClick={() => {}}
        >
          Make Your Payment
        </button>
